...
for z_dim in zed:
    ...
    for activity in ["all"]:
        ...
        torch.save(encodermodel.state_dict(), '/home/omid/pycharm/Mobi/models/single_vae_encoder_motion_'+activity+str(z_dim))
        torch.save(decodermodel.state_dict(), '/home/omid/pycharm/Mobi/models/single_vae_decoder_motion_'+activity+str(z_dim))
...
encodermodel_0.load_state_dict(torch.load('/home/omid/pycharm/Mobi/models/single_vae_encoder_motion_all'+str(z_dim)))
if usecuda:
    encodermodel_0.cuda(idgpu)
decodermodel_0 = Decoder().double()
decodermodel_0.load_state_dict(torch.load('/home/omid/pycharm/Mobi/models/single_vae_decoder_motion_all'+str(z_dim)))
if usecuda:
...
for activity in range(4):
    ...
    encodermodel.load_state_dict(torch.load('/home/omid/pycharm/Mobi/models/single_vae_encoder_motion_all'+str(z_dim)))
    if usecuda:
        encodermodel.cuda(idgpu)
    decodermodel = Decoder().double()
    decodermodel.load_state_dict(torch.load('/home/omid/pycharm/Mobi/models/single_vae_decoder_motion_all'+str(z_dim)))
    if usecuda:
        decodermodel.cuda(idgpu)
