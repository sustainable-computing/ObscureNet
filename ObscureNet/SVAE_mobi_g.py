...
'''
        ...
        torch.save(encodermodel.state_dict(), '/home/omid/pycharm/Mobi/models/obs_mobi_g_encoder_'+activity+str(z_dim))
        torch.save(decodermodel.state_dict(), '/home/omid/pycharm/Mobi/models/obs_mobi_g_decoder_'+activity+str(z_dim))
'''
'''
z_dim = 5
...
encodermodel_0.load_state_dict(torch.load('/home/omid/pycharm/Mobi/models/obs_mobi_g_encoder_all'+str(z_dim)))
if usecuda:
    encodermodel_0.cuda(idgpu)
decodermodel_0 = Decoder().double()
decodermodel_0.load_state_dict(torch.load('/home/omid/pycharm/Mobi/models/obs_mobi_g_decoder_all'+str(z_dim)))
if usecuda:
