...
for looooop in range(20):
    ...
    for activity in range(4):
        ...
        Y = act_train_labels
        # result1 = eval_act_model.evaluate(X, Y)
        # act_acc = round(result1[1], 4) * 100
    ...
    # def plot_signals(rnd_smpl, pts, org, tra, act_test_labels, act_index, file):
        ...
        # plot_signals(rnd_smpl, pts, train_data, X, act_train_labels, activity, "/data/org_prob_"+str(activity)+".pdf")
    ...
    # np.save("/home/omid/pycharm/Mobi/data/mobi_g_prob", X_all)
    ...
    # np.save("/home/omid/pycharm/Mobi/data/mobi_g_det", X_all)
    ...
    # np.save("/home/omid/pycharm/Mobi/data/mobi_g_rand", X_all)
