...
'''
        ...
        torch.save(encodermodel.state_dict(), '/home/omid/pycharm/Mobi/models/5vae_encoder_'+str(activity)+str(z_dim))
        torch.save(decodermodel.state_dict(), '/home/omid/pycharm/Mobi/models/5vae_decoder_'+str(activity)+str(z_dim))
'''
z_dim = 5
